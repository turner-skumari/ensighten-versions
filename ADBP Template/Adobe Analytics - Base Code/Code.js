...
s.linkInternalFilters = 'javascript:,example.com,example.net';
s.linkLeaveQueryString = false;
s.linkTrackVars = 'None';
s.linkTrackEvents = 'None';
s.visitor=window.Visitor.getInstance('7FF852E2556756057F000101@AdobeOrg');
s.usePlugins = true;


s.usePlugins = true;
s.doPlugins = function (s) {
    s.contextData["previouspage"] = s.getPreviousValue(s.pageName,"gpv_pn");
};
